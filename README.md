...
3) We can use pHcalculator.py to build the neural network and predict the pH value of an input image. 
4) Import the train/test dataset into the phcalc code in order to generate the neural network and train the model. 
5) 
